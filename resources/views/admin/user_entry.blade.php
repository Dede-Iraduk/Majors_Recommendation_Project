...
<div class="flex flex-col gap-5 p-10 py-20">
    <div class="flex gap-5 ml-5">
        ...
        <h1 class="text-orange-600 text-4xl font-bold h-[40px]">User Entries</h1>
    </div>
    <div class="text-center p-7 mt-2 text-sky-900 text-lg">All User Entries</div>

    <div class="w-full flex justify-center mb-10">
        <input class="shadow appearance-none border rounded w-[50%] py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline0" type="text" id="search-posts" name="student" placeholder="Search by Interest or grades or subjects">
